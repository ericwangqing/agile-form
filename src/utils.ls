...
async-object-visit = ({obj, visit-value, visit-obj, done})!->
  _async-object-visit null, obj, visit-value, visit-obj, !->
    done!


_async-object-visit = (key, value, visit-value, visit-obj, done)!->
  debug "key: #key, value: #value"
  if typeof value isnt 'object'
    visit-value key, value, done
  else
    <-! visit-obj.before key, value
    async.each-series (Object.keys value), (key, callback)!->
      _async-object-visit key, value[key], visit-value, visit-obj, callback
    , !->
        <-! visit-obj.after key, value
        done!
...
module.exports = {All-done-waiter, async-object-visit, load-fixture}
  # clean-db: clean-db
